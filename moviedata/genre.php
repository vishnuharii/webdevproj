...
<head>
  ...
  <title>Genre - Movie Database</title>
...
<body>
  ...
  <div class="container">
    <h1 class="display-4 my-4">Movies by Genre</h1>
    <form method="GET" action="genre.php" class="mb-4">
    ...
    <div class="row">
      <?php
        ...
        if (isset($_GET['genre'])) {
          $genre = mysqli_real_escape_string($connect, $_GET['genre']);
          ...
          if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo '<p class="text-muted">No movies found in this genre.</p>';
          }
        }
      ?>
    </div>
